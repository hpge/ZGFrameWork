...
{
    NSLog(@"app Document===%@",[NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES) lastObject]);
...
void UncaughtExceptionHandler(NSException * exception)
{
	...
	NSString *urlStr = [NSString stringWithFormat:@"mailto:haipeng.ge@china.zhaogang.com?subject=客户端bug报告&body=很抱歉应用出现故障,感谢您的配合!发送这封邮件可协助我们改善此应用<br>"
						"错误详情:<br>%@<br>--------------------------<br>%@<br>---------------------<br>%@",
