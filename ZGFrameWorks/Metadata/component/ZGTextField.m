                ...
                parentContainer: (ZGContainer*) parentContainer
{
  ...
  uiTextField = [[ZGUITextField alloc] init];
  return self;
}
                    ...
                    inContainer: (ZGContainer*) container
{
  ...
  /** 设置密码框 */
  if ([[propertiesMap objectForKey: MAR_TAG_ATTR_TYPE] isEqualToString:MAR_TAG_ATTR_TYPE_SECURETEXT])
  {
  ...
  /** 设置标题文字 */
 // uiTextField.contentMode = UIViewContentModeScaleAspectFit;
  //[uiTextField setContentVerticalAlignment:UIControlContentVerticalAlignmentCenter];
...
{
  [ZGUITextField setActiveField: textField];
  return TRUE;
}
...
{
  [uiTextField removeRegisterForKeyboardNotifications];
}
